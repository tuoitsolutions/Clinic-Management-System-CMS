...
interface IDialogConsultDeclineReq {
  open: boolean;
...
const DialogConsultDeclineReq: FC<IDialogConsultDeclineReq> = memo((props) => {
            ...
            continue_callback: async () => {
              dispatch(
                showPageLoading({
                  show: true,
                  loading_message:
                    "Declining consultation request, thank you for your patience",
                })
              );
  ...
  return (
    <>
      <FormDialog
        title="Inform the requester about the reason for the decline"
        open={props.open}
...
export default DialogConsultDeclineReq;
