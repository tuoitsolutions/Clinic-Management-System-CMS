...
import ConsultMedEntity, {
  ConsultMedTableModel,
} from "../../../Services/Entities/ConsultMedEntity";
import { PaginationModel } from "../../../Services/Models/PaginationModel";
import {
  TblColumnModel,
  TblInitialSortModel,
} from "../../../Services/Models/TableModels";
import DialogAddMedRecord from "./DialogAddMed";
import DialogUpdateMedRecord from "./DialogUpdateMed";

interface ITabMedRecord {
...
export const TabMedRecord: FC<ITabMedRecord> = memo(({ consult_req_pk }) => {
  ...
  const [data_table, set_data_table] = useState<null | ConsultMedTableModel>(
    null
  );
  ...
  const [selected_record, set_selected_record] =
    useState<null | ConsultMedEntity>(null);
                  ...
                  <TableBody>
                    ...
                    {data_table?.table?.map((row, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell>{row.med_desc}</TableCell>
