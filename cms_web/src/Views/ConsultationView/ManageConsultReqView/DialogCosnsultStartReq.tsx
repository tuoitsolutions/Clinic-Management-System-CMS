...
const DialogStartConsult: FC<IDialogStartConsult> = memo((props) => {
  ...
  return (
    <>
      <FormDialog
        title="Fill up the fields to start the consultation"
        open={props.open}
...
export default DialogStartConsult;
