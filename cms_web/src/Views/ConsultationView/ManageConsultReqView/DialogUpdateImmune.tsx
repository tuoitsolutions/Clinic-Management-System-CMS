...
interface IDialogUpdateImmune {
  open: boolean;
  handleCloseDialog: () => void;
  successCallback: () => void;
  selected_record: ConsultImmuneEntity;
}
...
const DialogUpdateImmune: FC<IDialogUpdateImmune> = memo((props) => {
        ...
        dispatch(
          setGeneralPrompt({
            ...
            continue_callback: async () => {
              ...
              const response = await ConsultImmuneApi.UpdateConsultImmune(
                payload
              );
  ...
  return (
    <>
      <FormDialog
        title="Update Patient Immunization"
        open={props.open}
...
export default DialogUpdateImmune;
