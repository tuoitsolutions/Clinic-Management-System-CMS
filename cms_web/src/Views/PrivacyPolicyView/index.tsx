...
import { StyledPrivacyPolicy } from "./styled";

interface IPrivacyPolicyView {}

const hosp_address = `Gorordo Avenue, Cebu City, 6000 Cebu.`;
const hosp_email = `psh@gmail.com`;
const hosp_sms_number = `+639299550278`;

const PrivacyPolicyView: FC<IPrivacyPolicyView> = memo(() => {
              ...
              <StyledPrivacyPolicy>
                ...
                <p className="paragraph-content">
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        <b>Website </b> refers to {APP_NAME}, accessible from
                        https://opd.perpetualsuccourcebu.com:60355/
                      </p>
                    </li>
                    <li>
                      <p>
                ...
                <p className="paragraph-content">
                  ...
                  <p>
                    ...
                    cookies here: All About Cookies by TermsFeed.
                  </p>
                  <p>
                ...
                <p className="paragraph-content">
                  ...
                  <ul>
                    <li>
                      <p>By email: {hosp_email}</p>
                    </li>
                    <li>
                      <p>By phone number: {hosp_sms_number}</p>
                    </li>
                  </ul>
                </p>
              </StyledPrivacyPolicy>
