...
import { APP_NAME, getAccessToken, SERVER_URL } from "../../Helpers/AppConfig";
import {
...
const OnlineConsultLinkView: FC<IOnlineConsultLinkView> = memo(() => {
  ...
  useEffect(() => {
    ...
    const fetch_data = async () => {
      ...
      const response = await ConsultRequestApi.GetCosultLinkInfo(hash_key);
      if (response.success) {
                          ...
                          <div className="chat-content">
                            <div className="sent-msg-ctnr">
                              {chat_messages.map((msg, i) => (
                                <div key={i} className="sent-msg-item">
                                  <CustomAvatar
                                    className="img"
                                    src=""
