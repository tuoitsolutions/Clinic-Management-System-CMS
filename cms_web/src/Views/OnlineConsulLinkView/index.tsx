...
import TabPatientVideoCall from "./TabPatientVideoCall";
...
const OnlineConsultLinkView: FC<IOnlineConsultLinkView> = memo(() => {
  ...
  }, [connection, dispatch, selected_consult_req]);
            ...
            {fetch_selected_consult_req ? (
                ...
                {!localStorage.getItem("jwt_oc") ? (
                    ...
                    <Container maxWidth="sm">
                      <div className="panel-container">
                        <div className="ctnr-title">
                          ...
                          <div className="sub">
                            This is to verify that we are communicating with the
                            right patient.
                          </div>
                        </div>
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} md={8} lg={9}>
                      <TabPatientVideoCall
                        consult_info={selected_consult_req}
                      />
                    </Grid>
              ...
              <>
                <Alert severity="error">
                  We are not able to retrieve this information of this
                  consultation link.
                </Alert>
              </>
            )}
